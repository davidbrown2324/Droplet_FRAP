...
//print(path)
input="E://DAVE_BROWN_RAW_DATA_BACKUP/2018/Raw Data/Exp0133.3";
...
output="E://DAVE_BROWN_RAW_DATA_BACKUP/2018/Data/Exp0133.3";
//print(output)
open(path)
setSlice(25) //Show the Bleach Frame (in this case 10)
